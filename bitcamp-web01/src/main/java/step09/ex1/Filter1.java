...
// 웹 애플리케이션 컴포넌트?
// - 서블릿: 클라이언트의 요청을 처리하는 역할
// - 필터: 서블릿을 실행하기 전/후에 보조 작업을 수행
// - 리스너(listener): 서블릿 컨테이너에서 특정 사건이 발생할 떄 작업을 수행
//
// 필터
...
// 필터 배치
// 1) 애노테이션으로 필터를 적용할
// - @WebFliter(필터를 적용할 URL)
// 2) DD Flie(web.xml)에 필터를 배치하기
//  <!--  필터 등록 -->
//  <!--
//  <filter>
...
public class Filter1 implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        // 최소로 필터 객체가 생성될 때 호출 된다.
        // 필터가 작업할 때  사용할 도구를 준비한다.
        ...
        @Override
        public void destroy() {
            // 웹 애플리케이션이 머무거나 서블릿 컨테이너를 멈출 때 호출된다.
            // 필터가 init()를 통해 준비했던 도구를 자원을 해제시키는 코드를 여기에 둔다.
            System.out.println("Filter1.distroy");
        }
