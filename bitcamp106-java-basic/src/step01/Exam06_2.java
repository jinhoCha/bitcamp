...
public class Exam06_2 {
    public static void main(String[] args) {
        ...
        System.out.println(987654567.8); 
        System.out.println(9.87654345678);
        ...
        // 결과 0.70000000000001
        // 이유 : 부동소수점을 2진수로 바꾸다보면 0으로 딱 안떨어지기때문이다.
        // 해결 : 시스템에서 필요한만큼 짤라서 사용하기.

    }
}
        // 32비트 (float) 메모리에 부동소수점을 저장할 때는
        // 유효자리수 7자리까지 (거의) 가능하다.
        // 64비트 (double) 메모리에 부동소수점을 저장할때는
        // 유효자릿수 15자리까지 (거의) 가능하다
        // 그래서 32비트 float을 단정도라 부르고 
        // 64비트는 두 배 정밀하게 값을 저장해서 배정도라고 부른다.
