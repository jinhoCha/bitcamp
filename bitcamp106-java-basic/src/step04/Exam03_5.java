...
public static void main(String[] args) {
    ...
    //    System.out.println(!a); //컴파일 오류!
        ...
        // ---------------------------------------------
        //     0000 0000 0000 0000 0000 0000 0100 0100 = 68 // 위아래 비교할때 둘다같으면 1 

        System.out.println(a | b) ; 
        // a = 0000 0000 0000 0000 0000 0000 0110 1100
        // b = 0000 0000 0000 0000 0000 0000 0101 0101
        // ---------------------------------------------
        //     0000 0000 0000 0000 0000 0000 0111 1101 = 125  // 둘중하나가 1이면 1

        System.out.println(a ^ b) ; 
        // a = 0000 0000 0000 0000 0000 0000 0110 1100
        // b = 0000 0000 0000 0000 0000 0000 0101 0101
        // ---------------------------------------------
        //     0000 0000 0000 0000 0000 0000 0011 1001  = 57 //    같으면 0 다르면 1

         // 비트연산에서 not은 ! 연산자가 아니라 ~연산자이다.
...
// 정리!
// => 도대체 비트 연산자는 어디에 사용하는가 ?
// - 이미지 및 영상 처리에 사용된다.
// = ex) 마스킹, 오버레이 기법에 사용된다.
// - ex) 색조 변경에 사용된다.
// 사진을 컴퓨터에 저장하려면 2진수화 시켜야 한다.
// 일단 사진을 점(픽셀)으로 바꾼다.
// 각 픽셀은 RGB의 값으로 표현( 빛의 삼원색)으로 표현한다.
// 즉 빨강,파랑,초록의 색 세기를 조정하여 다양한 색상을 표현하는 것이다.
// 보통 천연색으로 표현하기위해 RGB 각 색상을 8비트로 표현한다.
// 빨강 빛 : 0 ~255
// 파랑빛 : 0 ~ 255
// 초록빛 : 0 ~ 255
...
//비트 연산 활영 예 : 1
// -> 화면을 좀더 고전적으로 표현하고 싶다.
// 누리끼리하게 만들고싶다. 
// -> 방법 : 노란색 계통을 강화하는것이다.
// => 즉 빨강, 초록 빛을 강화하면 된다.
// ==> 다음과 같이 한개의 점이 있다.
// => 10001100 10010010 10101100
//    10010010 01001001 00000000
//   ----------------------------
//    10011110 11011011 10101100


//비트 연산 활영 예 : 2
// => 화면을 좀더 쉬원하고 , 푸르스름하게 만들자.
// => 방법 : 파란새 계통을 강화하거나
//          빨강이나 초록을 약화시키면 된다.
// => 10001100 10010010 10101100
//  & 11111011 11111101 11111111
//   ----------------------------
//    10001000 10010000 10101100
