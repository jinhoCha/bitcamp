...
public class Exam01_6 {
    ...
    public static void main(String[] args) {
        ...
        // 그런데 소스코드를 작성한 후에 숫자의 의미는 시간이 오래지나면 숫자의 의미를 기억하기가 쉽지않다.
        // 소스 코드를 작성한 사람도 숫자의 의미를 기억하기가 쉽지않은데
        // 남의 소스 코드를 유지보수하는 사람은 더더욱 숫자의 의미를 파악하기가 쉽지 않다.
        // 주석이나 개발문서를 자세히 살펴보지 않는이상에는 숫자의 의미를 파악하기가 쉽지않다.
        // 이런 경우를 방지하고자 나온 문법이 상수이다!
        // => 즉 의미있는 이름으로 변수를 만들어 놓고 그 변수에 숫자를 저장한다.
        // => 그리고 그값을 사용할 때는 변수를 통해 사용한다.
        // 다음은 상수를 통한 예이다.
