...
public class Exam01 {
    public static void main(String[] args) {
        ...
        // => 다음은 String과 int값을 순서대로 받는 m()을 호출한다.
        
        A.m("Hello", 100);
        
        //= > float 타입의 값을 받는 m()은 없기 떄문에 컴파일 오류!!
        //A.m(3.14f);
        // 메서드를 찾을 떄 아규먼트의 타입과 일칳나느 매서드를 찾기 때문에
        //메서드의 파라미터 이름은 아무 상관없다.
    }
}

//오버로딩(overloading)
//=> 파라미터 타입이나 개수, 순서는 다르지만 이름이 같은 메서드를 여러 개 만들수 있는 문법
//왜 이런 문법이 등장했는가?
